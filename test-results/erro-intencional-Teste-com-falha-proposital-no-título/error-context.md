...
- Name: Teste com falha proposital no título
- Location: C:\Users\amori\OneDrive\Desktop\projeto-qa-automacao\tests\erro-intencional.spec.js:3:5
...
Expected pattern: /Automação Perfeita/
Received string:  "Fast and reliable end-to-end testing for modern web apps | Playwright"
Call log:
  - expect.toHaveTitle with timeout 5000ms
  - waiting for locator(':root')
    3 × locator resolved to <html lang="en" dir="ltr" data-theme="light" data-rh="lang,dir,class" data-has-hydrated="false" class="plugin-pages plugin-id-default">…</html>
    ...
    at C:\Users\amori\OneDrive\Desktop\projeto-qa-automacao\tests\erro-intencional.spec.js:5:22
```
...
```ts
  ...
  2 |
  3 | test('Teste com falha proposital no título', async ({ page }) => {
  4 |   await page.goto('https://playwright.dev/');
> 5 |   await expect(page).toHaveTitle(/Automação Perfeita/); // título errado
    |                      ^ Error: Timed out 5000ms waiting for expect(locator).toHaveTitle(expected)
  6 | });
  7 |
```